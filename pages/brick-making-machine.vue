  ...
  <FlodyneContainer>
    ...
    <VRow>
      ...
      <VCol cols="12" md="8">
        ...
        <p>
          With time the facilities were increased to manufacture more quantity
          of 0.75 to 75 kw Canned Motor Pumps.
        </p>
        <p>
          Flowdyne pumps manufacturers a number of components in house and also
          procures from dedicated suppliers.
        </p>
        <p>
          Number of manufacturing machines such as CNC,Lathes, Presses, Welding
          Unit, and Winding Systems are available for manufacturing of
          components.
        </p>
        <p>
        ...
        <p>
          These facilities are utilized for testing of pumpsets produced by the
          production department personnel and also for developmental purposes.
        </p>
        <p>
